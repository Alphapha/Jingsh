...
<form action="upload.asp" method="post" enctype="multipart/form-data">
 <p>
	 <ol>
		 ...
		 <li>系统信息截图上传 (<a href="../notice.html" target="_blank">查看方法</a>)：<br>*大致信息如下图<br><img src="upload/202009281033026020.PNG"><br>*苹果电脑可以忽略此项<br><br><input type="file" id="file" name="file1" multiple="multiple" /></li>
		 <li>
			您目前使用以下哪种办公软件？<br>
			<select name="ll2">
				...
				<option value="Else">其他/不清楚</option>
		 ...
		 <li>日常办公中，您是否必须使用到Adobe系列办公软件? （目前仅统计）<br>
		 <select name="ll4">
			<option value="NoUse">可以不用</option>
		 	<option value="Use">必须使用</option>
		 </select><br>
		 *Adobe系列软件图标如下图所示：<br><img src="../img/jc6.jpg" /><br>
		 ...
		 <li>您目前工作中需要用到的软件（为利于后期专业软件采购,请尽可能全地填写）：<br>
			<textarea name="ll6" placeholder="以/作分隔,如:WPS/Photoshop......"></textarea>
		 </li>

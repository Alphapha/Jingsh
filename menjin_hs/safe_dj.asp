			...
			<div class="col-md-12 column">
				...
				<form class="form-horizontal" role="form" action="safe_dj_sql.asp" onsubmit="return Check()" method="post" name="order">
						...
						<select style="border-radius: 10;height: 30px;" class="form-con" name="menjin_card_num">
							<%
								sql="select * from hs_safe_card_statistics where 使用情况='0' limit 25"
								rs.CursorLocation = 3

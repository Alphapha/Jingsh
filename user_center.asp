...
<div class="container">
	<div class="row clearfix">
		<div class="col-md-12 column" id="mp" style="position: relative;padding: 5px 0 0 5px;">
			<%
				Userid=request.cookies("huancun")("Phone")
				cook=trim(request.Form("cook"))
				' response.write Userid
				' response.write cook
				set rs=server.CreateObject("adodb.recordset")
				' sql = "select * from member where Userid ='"&Userid&"'"
				sql = "select * from list where 手机 ='"&Userid&"'"
			...
			%>
			<img src="img/businesscard/2020-1-1.jpg" class="mpimg" />
			<div id="mz">
				<div id="xm"><%=rs("姓名")%></div>
				<div id="fh">丨</div>
	...
	<br><br><br>
			...
			<div id="hide">
				<div id="user_input1">&nbsp;&nbsp;&nbsp;上传<br>&nbsp;二维码</div><input type="file"  onchange="change(event)" id="user_input"  />
				<ul class="userul">
	...
	<div class="row clearfix">
		<div class="col-md-12 column" id="mp1">
			<img src="img/businesscard/2020-02.jpg"  class="mpimg" />
		</div>
	</div>
</div>
<br /><br /><br /><br /><br />
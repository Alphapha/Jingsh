...
<%
	...
	sql1 = "update js_list set 是否可补卡 ='不可' where 手机='"&menjin_phone&"'"
	sql2 = "insert into js_safe (姓名,手机,卡_人脸,卡_指纹,卡_电梯,费用_门禁卡,编号_门禁卡,门禁卡办理时间,门禁卡办理IP,服务类型,是否可退卡,退卡卡号) values('"&menjin_name&"','"&menjin_phone&"','已录','已录','已录','"&menjin_card_fee&"','"&menjin_card_num&"','"&tim&"','"&ip&"','补卡','可','"&menjin_card_num&"') "

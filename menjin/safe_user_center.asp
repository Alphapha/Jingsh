	...
	<div class="row clearfix" style="margin: 10px 2%; opacity: 1;>
		<div class="col-md-12 column" style="position: relative;padding: 5px 0 0 5px;opacity: 1;">
			<%
				...
				sql = "select * from js_safe where 姓名='"&menjin_name&"' and 手机 ='"&menjin_phone&"'"
			...
			<div >
				...
				<h4>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;您于&nbsp;<b><%=rs("门禁卡办理时间")%></b>&nbsp;在京师上海国际总部办理了门禁一卡通业务，卡号为&nbsp;<b><%=rs("编号_门禁卡")%></b>&nbsp;，支付凭证号为&nbsp;<b><%=rs("费用_门禁卡")%></b>&nbsp;，绑定的手机号为&nbsp;<b><%=rs("手机")%></b>&nbsp;，此界面截图作为凭证，领取门禁卡时请出示此截图。</h4><br><br>
					<h5>随同附上</h5>
					<h5>我衷心希望</h5>
					<h5>您永远用不到的</h5>
					<h5>温馨小贴士：</h5>

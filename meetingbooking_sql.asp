...
<%
	...
	sql = "select * from meetorder where DATE='"&rq&"' and ROOM='"&hys&"' and TIME='"&sj&"'"
	...
	if sj1 <> "" then
		sql1 = "select * from meetorder where DATE='"&rq&"' and ROOM='"&hys&"' and TIME='"&sj1&"'"
	...
	if sj2 <> "" then 
		sql2 = "select * from meetorder where DATE='"&rq&"' and ROOM='"&hys&"' and TIME='"&sj2&"'"
	...
	if sj3 <> "" then
		sql3 = "select * from meetorder where DATE='"&rq&"' and ROOM='"&hys&"' and TIME='"&sj3&"'"
	...
	response.write "<meta http-equiv='refresh' content='0;URL=meetingbooking_sql_1.asp'>"
